...
export interface InitOutput {
    ...
    readonly get_ai_action: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly select_action_from_scores: (a: number, b: number, c: number, d: number, e: number, f: bigint) => void;
